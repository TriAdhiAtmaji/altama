...
public class ForecastRecomendBuilder {
    ...
    public ForecastRecomendBuilder setCurrencyLastPO(String currencyLastPO) {
    ...
    public ForecastRecomend createForecastRecomend() {
        return new ForecastRecomend(m_product_id, c_bpartner_id, c_elementvalue_id, z_m_factory_id, m_pricelist_version_id, product, qtyAvailable, qtyAverage, leadTime, qtyBatasAtas, qtyOnOrdered, priceListJual, currencyLastPO, priceListLastPO, moq, qtyPcsPerMasterBox, recomendQtyPOPcs, totalMasterBox);
    }
