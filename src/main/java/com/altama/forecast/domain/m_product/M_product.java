...
public class M_product implements EntityObject<M_product> {
    ...
    public int hashCode() {
        ...
        hash = 23 * hash + Objects.hashCode(this.c_uom_id);
        hash = 23 * hash + Objects.hashCode(this.salesrep_id);
        hash = 23 * hash + Objects.hashCode(this.c_revenuerecognition_id);
        hash = 23 * hash + Objects.hashCode(this.m_product_category_id);
        hash = 23 * hash + Objects.hashCode(this.classification);
        hash = 23 * hash + Objects.hashCode(this.volume);
        hash = 23 * hash + Objects.hashCode(this.weight);
        hash = 23 * hash + Objects.hashCode(this.m_locator_id);
        hash = 23 * hash + Objects.hashCode(this.wmsvalue);
        hash = 23 * hash + Objects.hashCode(this.isDiscontinue);
        return hash;
    }
